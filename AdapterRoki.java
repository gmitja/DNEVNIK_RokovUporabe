...
public class AdapterRoki extends RecyclerView.Adapter<AdapterRoki.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if(mDataset.sizeDnevnik()>0) {
            ...
            Artikli tren=mDataset.getArtiklById(position);
            final String name = tren.getNaziv();
            holder.txtHeader.setText(tren.getNaziv());
            holder.txtFooter.setText(tren.getOpis());
